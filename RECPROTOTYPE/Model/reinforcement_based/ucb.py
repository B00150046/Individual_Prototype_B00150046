...
# (In real system, use real item/user features)
# -----------------------------
np.random.seed(0)
...
# -----------------------------
# Training / Simulate recommendations
# -----------------------------
for _, row in df.iterrows():
    ...
    print(f"User {row['user_id']} recommended item {chosen_item} -> reward {reward}")